...
function newSwatch(gen) {
    ...
    console.log(document.querySelectorAll('.swatchy-trigger').item(0));
    console.log(document.querySelectorAll('.swatchy-trigger').item(1));
    console.log(document.querySelectorAll('.swatchy-trigger').item(2));
    console.log(document.querySelectorAll('.swatchy-trigger').item(3));
    console.log(document.querySelectorAll('.swatchy-trigger').item(4));
    document.querySelectorAll('.swatchy-trigger').item(gen - 1).addEventListener('click', togglePopup)
    output = document.querySelectorAll('.swatchy-output').item(gen - 1)
    ...
    function selectColor(e) {
        let input = document.querySelectorAll('.swatchy-output').item(gen - 1)
        let newColor = e.target.getAttribute('data-swatchy-color')
        let secondColor = e.target.previousSibling.getAttribute('data-swatchy-color');
        console.log(secondColor)
    ...
    function togglePopup() {
        let el = document.querySelectorAll('.swatchy-element').item(gen - 1)
